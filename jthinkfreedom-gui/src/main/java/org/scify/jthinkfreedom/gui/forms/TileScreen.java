 ...
 * @author xrousakis
 */
public class TileScreen extends javax.swing.JFrame {
    ...
    private final String xmlPath = System.getProperty("user.dir") + "/categories.xml";
    ...
    public Border createBorder(Color color) {
        Border border = BorderFactory.createLineBorder(color, 2);
        return border;
    }

    /*Takes teh information from the components and inserts them into the xml*/
    private void submitButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_submitButtonActionPerformed
        // TODO add your handling code here:
        String text = jTextField1.getText().toString();
        if (imageName == null) {
            JOptionPane.showMessageDialog(this, "You didnt select image");
        } else {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TileScreen.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TileScreen().setVisible(true);
            }
        });
    }
